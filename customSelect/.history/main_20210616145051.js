    ...
    listOptions.forEach(function(optionEl,index){
        ...
        var liElement = document.createElement('li');
            ...
            liElement.addEventListener('click',function(e){
                ...
                // select.querySelector(selectString).parentElement.nextElementSibling.classList.remove('open');

                console.log(this.parentElement.parentElement.classList.remove('open'));
