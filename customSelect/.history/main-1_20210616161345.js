...
var listSelect = Array.from(document.querySelectorAll('.' + classPlugin))
    ...
    listSelect.forEach(function(select){
        ...
        listOptions.forEach(function(optionEl,index){
            ...
            if(optionEl.getAttribute(classSelected ) !== null){
